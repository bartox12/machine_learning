...
Lab assignments from an introductory machine learning course. Each lab lives in its own folder as a Jupyter notebook with a short README. Notebook comments are written in Polish.
